...
_kcc() {
  ...
  case $kn in
    25)
	ki=storageos/kind-node:v1.25.0
	;;
    24)
    ...
    ;;
    22)
      ki=storageos/kind-node:v1.22.3
    ;;
    21)
      ki=storageos/kind-node:v1.21.0
    ;;

    20)
      ki=storageos/kind-node:v1.20.5
    ;;

    19)
      ki=storageos/kind-node:v1.19.0
    ;;

    18)
      ki=storageos/kind-node:v1.18.6
    ;;

    *)
      echo "Wrong parameter given fallback to latest"
      ki=storageos/kind-node:v1.23.0
    ;;
  esac
